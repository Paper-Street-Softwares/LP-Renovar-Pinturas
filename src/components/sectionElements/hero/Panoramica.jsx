  ...
  return (
    <>
      <div id="home">
        ...
        >
          <div className="w-full bg-top bg-repeat font-mainFont desktop1:hidden">
                  ...
                  <div className="flex flex-col w-full desktop1:w-[50%] desktop1:mr-[20px]">
                    ...
                    <MotionDivDownToUp>
                      <div className="flex justify-center w-full text-center desktop1:text-left desktop1:justify-start font-secondFont text-paragraph4 phone3:text-paragraph5">
                        <p className="text-white mb-[32px] mt-2">
                          {t("hero.subtitle")}{" "}
                        </p>
                      </div>
                    </MotionDivDownToUp>
        ...
        {/* desktop */}
        <div
          className="hidden w-full bg-top bg-repeat bg-cover font-mainFont desktop1:flex desktop1:justify-start "
          style={{
            backgroundImage: `url(${
              window.innerWidth < 1024
                ? content.texts.hero.heroImgPhone
                ...
                <div className="w-full text-secondary ">
                  ...
                  <div className="flex flex-col-reverse gap-[40px] desktop1:flex-row desktop1:justify-between w-full items-center pb-[64px] pt-[40px] desktop1:pt-[0px] desktop1:pb-[0px]">
                    <div className="flex flex-col w-full desktop1:w-full ">
                      <MotionDivDownToUp>
                        <div className="flex justify-center w-auto text-center desktop1:justify-start desktop1:text-center font-secondFont text-paragraph4">
                      ...
                      <MotionDivDownToUp>
                        <div className="text-primary w-[40%] flex justify-center desktop1:justify-start font-bold leading-[40px] phone3:leading-[42px] tablet1:leading-[70px] desktop1:leading-[60px] desktop2:leading-[65px] text-center desktop1:text-left text-title4 phone2:text-title5 phone3:text-title5 tablet1:text-title7">
                          <h1>
                            <span
                              dangerouslySetInnerHTML={{
                                __html: t("hero.title"),
                      ...
                      <MotionDivDownToUp>
                        <div className="flex justify-center w-[45%] text-center desktop1:text-left desktop1:justify-start font-secondFont text-paragraph4 phone3:text-paragraph5">
